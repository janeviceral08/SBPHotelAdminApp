...
{acPass =='eye'?
<Icon type='Octicons' active name={acPass} style={{color: 'black'}} onPress={()=> {setacPass('eye-closed'); setsec(false)}}/>
:
<Icon type='Octicons' active name={acPass} style={{color: 'black'}} onPress={()=> {setacPass('eye'); setsec(true)}}/>
}
