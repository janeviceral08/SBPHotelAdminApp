...
export function Report_Result_Out({ navigation, route}) {
  ...
  return (
   ...
   <View style={styles.mainContainer}>
          ...
          <Item>
            ...
            <Input placeholder="Checked-out report Search Customer Name" style={{borderColor: 'red'}}    onChangeText={(text) => searchData(text)}/>
