...
export function Report_FD_out({navigation}) {
...
console.log('checkout: ',checkout.length)
  const requestRunTimePermission=()=>{
    ...
    const name = 'FD Check-out ('+ date_now +' )'+'.xlsx'
  ...
  return (
   ...
   <View style={styles.mainContainer}>
          ...
          <Item>
            ...
            <Input placeholder="FD Check out Search Customer Name" style={{borderColor: 'red', fontSize: 13}}    onChangeText={(text) => searchData(text)}/>
