...
export function Report_Res_Ref({navigation}) {
  ...
  const reports_info = allRef.map( ({check_in, check_out, room_no,room_type, customer,company,contact,control_num,discount,discount_code,discount_less, email, extension_total_amount, extension_person,extension_price,extension_rate,  nationality,extra_person, checkin_stat , hour_duration, no_person, no_person_discount, refund, note, penalty, penalty_description, res_code, total_addtional}) => ({check_in, check_out, room_no,room_type, customer,company,contact,control_num,discount,discount_code,discount_less, email, extension_total_amount, extension_person,extension_price,extension_rate,  nationality,extra_person, checkin_stat , hour_duration, no_person, no_person_discount, refund, note, penalty, penalty_description, res_code, total_addtional }) )
...
console.log('allRef: ',allRef.length)
  const requestRunTimePermission=()=>{
    ...
    const name = 'Refund Reservation ('+ date_now +' )'+'.xlsx'
  ...
  const  printHTML = async () => {
    ...
    <h1>Generated Report on Reservation Refunded ${moment().format('MMM-D-YYYY h:mm a')}</h1>
                    ...
                    <CardItem bordered button onPress={()=> navigation.navigate('Customer_Details', {checkinInfo: item})}>
                      <Left  style={{marginTop: -10, marginBottom: -10}}>
                        ...
                        <Body>
                          ...
                          <Text note style={{width: '150%'}}>{currencyFormat(parseFloat(item.refund))} </Text>
                        </Body>
                      </Left>
                      <Right>
