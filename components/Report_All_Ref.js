...
export function Report_All_Ref({navigation}) {
...
console.log('allRef: ',allRef.length)
  ...
  const  printHTML = async () => {
    ...
    <h1>Generated Report on All Refunded ${moment().format('MMM-D-YYYY h:mm a')}</h1>
  ...
  return (
   ...
   <View style={styles.mainContainer}>
          ...
          <Item>
            ...
            <Input placeholder="All Refund Search Customer Name" style={{borderColor: 'red', fontSize: 13}}    onChangeText={(text) => searchData(text)}/>
                    ...
                    <CardItem bordered button onPress={()=> navigation.navigate('Customer_Details', {checkinInfo: item})}>
                      <Left  style={{marginTop: -10, marginBottom: -10}}>
                        ...
                        <Body>
                          ...
                          <Text note>{currencyFormat(parseFloat(item.refund))}</Text>
                        </Body>
                      </Left>
                      <Right>
