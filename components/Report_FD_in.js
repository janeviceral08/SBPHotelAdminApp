...
export function Report_FD_in({navigation}) {
...
console.log('checkout: ',checkout.length)
  const requestRunTimePermission=()=>{
    ...
    const name = 'FD Check-in ('+ date_now +' )'+'.xlsx'
  ...
  return (
   ...
   <View style={styles.mainContainer}>
          ...
          <Item>
            ...
            <Input placeholder="FD Check in Search Customer Name" style={{borderColor: 'red', fontSize: 13}}    onChangeText={(text) => searchData(text)}/>
