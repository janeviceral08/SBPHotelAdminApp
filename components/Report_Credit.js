...
export function Report_Credit({navigation}) {
...
console.log('checkout: ',checkout.length)
  const requestRunTimePermission=()=>{
    ...
    const name = 'Credit ('+ date_now +' )'+'.xlsx'
  ...
  return (
   ...
   <View style={styles.mainContainer}>
          ...
          <Item>
            ...
            <Input placeholder="CC Payment Search Customer Name" style={{borderColor: 'red', fontSize: 13}}    onChangeText={(text) => searchData(text)}/>
