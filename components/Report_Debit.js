...
export function Report_Debit({navigation}) {
...
console.log('checkout: ',checkout.length)
  const requestRunTimePermission=()=>{
    ...
    const name = 'Debit ('+ date_now +' )'+'.xlsx'
  ...
  return (
   ...
   <View style={styles.mainContainer}>
          ...
          <Item>
            ...
            <Input placeholder="DC Payment Search Customer Name" style={{borderColor: 'red', fontSize: 13}}    onChangeText={(text) => searchData(text)}/>
