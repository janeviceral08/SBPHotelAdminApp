...
export function Report_res_out({navigation}) {
...
console.log('checkout: ',checkout.length)
  const requestRunTimePermission=()=>{
    ...
    const name = 'Reservation ('+ date_now +' )'+'.xlsx'
  ...
  return (
   ...
   <View style={styles.mainContainer}>
          ...
          <Item>
            ...
            <Input placeholder="Reservation Check-out Search Customer Name" style={{borderColor: 'red', fontSize: 13}}    onChangeText={(text) => searchData(text)}/>
